        ...
        <CardContent className="p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h1 className="text-3xl font-semibold tracking-tight">JV Access</h1>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">Control the general menu and action access for all JV users.</p>
            </div>
          </div>
        </CardContent>
      </Card>
