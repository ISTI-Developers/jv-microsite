...
import { RevenueAccountTitle, RevenueAccountTitleColumnsProps } from './types';

function isAccountEnabled(item: RevenueAccountTitle) {
  return Number(item.is_enabled) === 1;
}

export function createRevenueAccountTitleColumns({
  currentEnabledByAccountNo,
  setAccountEnabled,
  isSaving,
}: RevenueAccountTitleColumnsProps): Column<RevenueAccountTitle>[] {
  return [
    {
      header: 'Enabled',
      align: 'center',
